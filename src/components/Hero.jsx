  ...
  return (
    <>
      <div className="relative isolate px-6 pt-14 lg:px-8 mb-56">
        ...
        >
          <div
            className=" back animate-roam relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#ffdf80] to-[#89fc91] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
        ...
        <div className="mx-auto max-w-2xl py-4 sm:py-4 lg:py-4">
          ...
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="#"
                className=" bg-white bg-opacity-10 px-6 py-4 text-lg font-semibold text-gray-400 shadow-sm rounded-sm border border-gray-200 border-opacity-20 cursor-none"
              >
