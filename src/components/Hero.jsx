      ...
      <div className="relative isolate px-6 pt-14 lg:px-8 mb-56">
        ...
        <div className="mx-auto max-w-2xl py-4 sm:py-4 lg:py-4">
          ...
          <div className="text-center">
            ...
            <p className="animate-text mt-6 text-4xl leading-25 font-bold text-gray-300 text-transparent bg-clip-text bg-gradient-to-tr from-[#d7d7d7] to-[#616161] sm:text-3xl md:text-5xl">
