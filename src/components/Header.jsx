    ...
    return(
        ...
        <section className="top-5 z-50 mx-auto m-6 w-5/6">
            <nav className="flex items-center justify-between">
                <a href="mailto:technicalrohit06@gmail.com" className=' flex flex-row items-center justify-center cursor-none'>
                ...
                <h3 href='mailto:technicalrohit06@gmail.com' className=" hidden pl-4 text-gray-300 lg:flex md:flex cursor-none"> technicalrohit06@gmail.com</h3>
                </a>
                
                <h3>
                    <div className="flex flex-1 gap-3 text-gray-300">
                       <a href='https://instagram.com/rohitk.06' className='flex flex-row items-center justify-center cursor-none'>
                       ...
                       <a href='https://github.com/DevRohit06' className='flex flex-row items-center justify-center cursor-none'>
                       ...
                       <h2 className="text-gray-300 hidden lg:flex md:flex">Github</h2>
                        ...
                        <a className="text-gray-300 hidden lg:flex md:flex cursor-none">Linkedin</a> 
                        </div>
                    </div>
                </h3>
            </nav>
